...
Source0  : https://github.com/fontforge/libuninameslist/archive/20210917/libuninameslist-20210917.tar.gz
...
%prep
%setup -q -n libuninameslist-20210917
cd %{_builddir}/libuninameslist-20210917
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632180541
...
cp %{_builddir}/libuninameslist-20210917/COPYING %{buildroot}/usr/share/package-licenses/libuninameslist/e9cf76556aab3f1d3c2a70d8c96bceb4a681ebe3
%make_install
...
/usr/lib64/libuninameslist.so.1.0.9
